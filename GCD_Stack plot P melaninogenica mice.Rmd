...
ggsave("GCC_Distribution of Bacterial taxa at phylum level in in P melaninogenica mice.tiff", height = 4, width = 5)
```
```{r}
...
ggsave("GCC_family level in  P melaninogenica with S24_7.tiff", height = 4, width = 5)
ggsave("GCC_family level in  P melaninogenica with S24_7.pdf", height = 4, width = 5)
...
ggsave("Distribution of bacterial taxa at genus level in P melaninogenica mice.tiff", height = 4, width = 5)
ggsave("Distribution of bacterial taxa at genus level in P melaninogenica mice.pdf", height = 4, width = 5)
```